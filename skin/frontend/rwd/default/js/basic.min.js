...
!function(){$(function(){$.each($(".basic__navigation"),function(){new t($(this))})});var t=function(t){var o=t,e=o.offset().top,n=o.offset().left,s=o.find(".basic__navigation-current-item"),i=o.find(".basic__navigation-item"),f=$(".site"),c=f.find(".basic"),a=c.find(".basic__article"),r=a.find(".anchor"),l=$("html"),u=$("body"),h=$(window),p=0,d=function(){v(),g(),_()},v=function(){f.on("click",function(t){o.hasClass("open")&&0==$(t.target).closest(o).length&&T(p)}),h.on({scroll:function(){g(),_()},resize:function(){n=o.offset().left}}),s.on("click",function(){return o.hasClass("open")?T(p):C(),!1}),i.on("click",function(){var t=$(this);return t.addClass("hover"),m(t),setTimeout(function(){t.removeClass("hover")},500),!1})},m=function(t){var o=t;h.outerWidth()<996?T($(o.attr("href")).offset().top-s.outerHeight()-15):u.animate({scrollTop:$(o.attr("href")).offset().top-25},600)},C=function(){p=h.scrollTop(),o.addClass("open"),setTimeout(function(){u.scrollTop(o.offset().top)},100),setTimeout(function(){u.css("overflow-y","hidden")},200)},T=function(t){p=t,u.removeAttr("style"),setTimeout(function(){u.scrollTop(p),g()},100),o.removeClass("open")},g=function(){var t=a.offset().top+a.outerHeight()-o.outerHeight();u.scrollTop()>=e||l.scrollTop()>=e?(o.removeAttr("style"),b(),o.offset().top>=t&&o.css({position:"absolute",top:t-c.offset().top,left:0})):o.hasClass("open")||w()},_=function(){r.each(function(){var t=$(this),e=i.filter('[href="#'+t.attr("id")+'"]');o.offset().top>=t.offset().top&&(i.removeClass("active"),e.addClass("active"),s.html(e.text()))})},b=function(){o.addClass("fixed"),o.css("left",n)},w=function(){o.removeClass("fixed"),o.css("left",0)};d()}}();
