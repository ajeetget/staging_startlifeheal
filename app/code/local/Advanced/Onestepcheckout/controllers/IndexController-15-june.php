    ...
    public function saveOrderAction() {
        ...
        if ($redirectUrl && $redirectUrl != '') {
            ...
            try {
				...
				$customer->setWebsiteId(Mage::app()->getWebsite()->getId());
				$customer->loadByEmail($billingData['email']);
				$customer->setPrimarymobileno($billingData['telephone']);
				$customer->save();
			...
			//////////////////////// inform new customer registeration by sending Email /////////////////////
				...
				$primarymobileno = trim($billingData['primarymobileno']);
				...
				$message="Hi, a new customer ".$customerName." with mobile number ".$primarymobileno." and email ".$email." registered from checkout page of lifeheal.in on  ".date("d-m-Y");
