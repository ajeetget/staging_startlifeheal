 ...
 */
class Advanced_Onestepcheckout_Model_Mysql4_Fieldsposition extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {   
        $this->_init('onestepcheckout/fieldsposition', 'onestepcheckout_field_position_id');
    }
}