 ...
 */
class Advanced_Onestepcheckout_Model_Config_Actionaddress {

    public function toOptionArray() {

        $arr = array();

        $arr = array(array('value' => 'shipping_method', 'label' => Mage::helper('onestepcheckout')->__('Shipping Method'))
            , array('value' => 'payment_method', 'label' => Mage::helper('onestepcheckout')->__('Payment Method'))
