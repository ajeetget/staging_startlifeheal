...
class Advanced_Onestepcheckout_Model_Config_Column {
    public function toOptionArray()
    {
      
        $arr = array();
        
            $arr = array(array('value'=>'1', 'label'=>Mage::helper('onestepcheckout')->__('1 Column'))
                            ,array('value'=>'2', 'label'=>Mage::helper('onestepcheckout')->__('2 Columns'))
                            ,array('value'=>'3', 'label'=>Mage::helper('onestepcheckout')->__('3 Columns'))
                            ,array('value'=>'3bs', 'label'=>Mage::helper('onestepcheckout')->__('3 Columns Basic')));
