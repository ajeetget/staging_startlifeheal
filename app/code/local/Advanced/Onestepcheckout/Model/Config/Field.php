...
class Advanced_Onestepcheckout_Model_Config_Field {
    public function toOptionArray()
    {
      
        $arr = array();
        
            $arr = array(array('value'=>'country', 'label'=>Mage::helper('onestepcheckout')->__('Country'))
                            ,array('value'=>'state', 'label'=>Mage::helper('onestepcheckout')->__('State'))
                            ,array('value'=>'postcode', 'label'=>Mage::helper('onestepcheckout')->__('Zip/Post Code')));
