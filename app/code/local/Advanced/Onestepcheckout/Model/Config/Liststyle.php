 ...
 */
class Advanced_Onestepcheckout_Model_Config_Liststyle {

    public function toOptionArray() {

        $arr = array();

        $arr = array(array('value' => 'standard', 'label' => Mage::helper('onestepcheckout')->__('Icon'))
            , array('value' => 'number', 'label' => Mage::helper('onestepcheckout')->__('Number'))
        );
