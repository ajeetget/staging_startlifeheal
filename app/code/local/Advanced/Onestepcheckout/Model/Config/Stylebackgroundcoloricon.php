 ...
 */
class Advanced_Onestepcheckout_Model_Config_Stylebackgroundcoloricon {

    public function toOptionArray() {

        $arr = array();

        $arr = array(array('value' => '1', 'label' => Mage::helper('onestepcheckout')->__('Darken'))
            , array('value' => '0', 'label' => Mage::helper('onestepcheckout')->__('Lighten'))
        );
