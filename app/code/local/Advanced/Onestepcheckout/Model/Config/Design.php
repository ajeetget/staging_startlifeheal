...
class Advanced_Onestepcheckout_Model_Config_Design {
    public function toOptionArray()
    {
      
        $arr = array();
        
            $arr = array(array('value'=>'flat', 'label'=>Mage::helper('onestepcheckout')->__('Flat'))
                            ,array('value'=>'material', 'label'=>Mage::helper('onestepcheckout')->__('Material'))
                            //,array('value'=>'kendoui', 'label'=>Mage::helper('onestepcheckout')->__('Kendo-ui'))
                            //,array('value'=>'bootstrap', 'label'=>Mage::helper('onestepcheckout')->__('Bootstrap'))
                );
