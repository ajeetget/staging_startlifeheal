...
$varSMSURL = "http://msg160.com/sendsms/send1?userid=lifeheal&pass=lifeheal2019&sender=UPDATE&mobile=".$mobile."&message=".$message."&route=5&sms_type=Unicode";
                ...
                $message = urlencode($orderMessage);  
                        ...
                        //  $varSMSURL = "http://msg160.com/sendsms/send1?userid=lifeheal&pass=lifeheal2019&sender=LIFEHL&mobile=".$mobileNo."&message=".$message."&route=5";
						 ...
						 $varSMSURL = "http://msg160.com/sendsms/send1?userid=lifeheal&pass=lifeheal2019&sender=UPDATE&mobile=".$mobileNo."&message=".$message."&route=5";
