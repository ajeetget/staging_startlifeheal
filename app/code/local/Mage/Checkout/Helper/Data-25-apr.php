...
class Mage_Checkout_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	$order = Mage::getModel('sales/order')->loadByIncrementId($OrderNumber);
       ...
       // $tmpMessage="For order no ".$incrementId .", order amount is Rs".$grandTotal; //die;
         ...
         $tmpMessage="Thanks  for  your order no ".$incrementId;
         $tmpMessage.=". It will be delivered as soon as possible, but ours is slow food, not fast food, so it will take some time.";
         $tmpMessage.="For any queries pls call +91-9999846622";
