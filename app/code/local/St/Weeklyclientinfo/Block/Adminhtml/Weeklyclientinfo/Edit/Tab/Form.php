...
class St_Weeklyclientinfo_Block_Adminhtml_Weeklyclientinfo_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
		protected function _prepareForm()
		{
				...
				$fieldset = $form->addFieldset("weeklyclientinfo_form", array("legend"=>Mage::helper("weeklyclientinfo")->__("Item information")));
						...
						"label" => Mage::helper("weeklyclientinfo")->__("Height"),
						"name" => "height",
						));
						...
						$fieldset->addField("uppperbp", "text", array(
						"label" => Mage::helper("weeklyclientinfo")->__("Upper BP"),
						"name" => "uppperbp",
						));
						
						$fieldset->addField("lowerbp", "text", array(
						"label" => Mage::helper("weeklyclientinfo")->__("Lower BP"),
						"name" => "lowerbp",
						));
						
						$fieldset->addField("tg", "text", array(
						"label" => Mage::helper("weeklyclientinfo")->__("TG"),
						"name" => "tg",
						));
						
						$fieldset->addField("hdl", "text", array(
						"label" => Mage::helper("weeklyclientinfo")->__("HDL"),
						"name" => "hdl",
						));
						
						$fieldset->addField("fastingggl", "text", array(
						"label" => Mage::helper("weeklyclientinfo")->__("Fasting Glucose"),
						"name" => "fastingggl",
						));
