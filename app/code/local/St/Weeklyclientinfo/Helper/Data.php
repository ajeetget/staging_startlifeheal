		...
		if(count($collection)>0)
		{
			...
			//////////////////////////////// Calculate Blood Pressure /////////////////////
				...
				{					
					...
					else if( $finalHdl >=50 && $gender=='Male' )
					{
						$diseaseResult['hdlresult']=$good; 
						$diseaseResult['hdlabel']='Ideal'; 
					}
					else if( $finalHdl >=60 && $gender=='Female' )
					{
						$diseaseResult['hdlresult']=$good; 
						$diseaseResult['hdlabel']='Ideal'; 
					}
				...
				if($finalWaistToHeight!='' && $finalWaistToHeight>0)
				{
					...
					else if( $finalWaistToHeight > .46 && $finalWaistToHeight < .50)
					{
						 $diseaseResult['WaistToHeightResult']=$good;  
						 $diseaseResult['ratiolabel']='Healthy';  
					}
					else if( $finalWaistToHeight > .50 && $finalWaistToHeight < .63)
					{
						 $diseaseResult['WaistToHeightResult']=$notgood;  
