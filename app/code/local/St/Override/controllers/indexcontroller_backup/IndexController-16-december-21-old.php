     ...
     $dbinfo = array("host" => $config->host,"user" => $config->username,"pass" => $config->password,"dbname" => $config->dbname);    
      ...
      if (mysqli_connect_errno()) {
         ...
         exit();
            ...
            $totalfields =['name','date','consultant_name','gender','height_feet','height_inch','age','weight','weight_current','waist','sleep_quality','mood','energy','stresslevel','sleephour','exercisemin','exerciseday','clinical_diagnosis','current_medication','current_symptoms','recent_success','next_step','other_discussion','follow_up'];
