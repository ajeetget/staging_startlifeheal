        ...
        <div class="whitebox">
            ...
            <div class="challenges-bottom">
                <div class="challenges-bottom-inner">
                    ...
                    <div class="challenges-bottom-inner-right">
                        ...
                        <div class="height-col">
                            <input type="text" name="height" id="height" placeholder="feet" >
                            <input type="text" name="height" id="height" placeholder="inches" value="<?php echo $row['height'];?>">
                        </div>
                ...
                <div class="challenges-bottom-inner">
                    ...
                    <div class="challenges-bottom-inner-right">  
                        ...
                        <input type="text" name="waist" id="waist" value="<?php echo $row['waist'];?>"  placeholder="inches" >
                    </div>                            
                </div>
                ...
                <div class="challenges-bottom-inner">
                    <div class="challenges-bottom-inner-left">
                        ...
                        <input type="number" step="0.5" name="sleephour"  value="<?php echo $row['sleephour'];?>">
                    </div> 
                    <div class="challenges-bottom-inner-right">
                        <label for="exercisemin">How Many Minutes A Day Do You Exercise?</label>
                        <input type="number" step="1" name="exercisemin" value="<?php echo $row['exercisemin'];?>" >
          ...
          <?php 
            $symptoms_checkbox_left = [
              "Acid Reﬂux"=>"acid", "Alzheimers disease"=>"alzheimers", "Asthma"=>"asthama", "Bloating"=>"bloating", "Blood pressure"=>"bp", "Blurred vision"=>"blurred_vision", "body_pains"=>"body_pains", "Cardiac Diseases"=>"cardiac_disease", "Cervical Pain"=>"cervical", "Cholesterol"=>"cholestrol", "Constipation"=>"constipation", "COPD"=>"copd", "Dental Health complications"=>"dental_health_complication", "Depression"=>"depression", "Diabetes"=>"diabetes", "Eating disorders"=>"eating_disorders"
            ]; 
            ...
            <h3>Please Check Any Symptoms You Are Facing</h3>
                ...
                <div class="lifestyle-medication">
                     <label for="stresslevel">Your Stress Level On A Scale of 0-10</label>
                        <input type="number" step="0.5" name="stresslevel" value="<?php echo $row['stresslevel'];?>">
                </div>
            </div>  <!--end of symptoms -->                    
            <input type="button" name="previous" class="previous action-button-previous" value="Previous" /> 
            <input type="button" name="next" class="next action-button" value="Next Step" />                   
            ...
            <div class="lifestyle-section">
                ...
                <div class="form-lifestyle">
                    <div class="chicken_per_week">
                        ...
                        <input type="number" step="1" name="chicken_per_week" id="chicken_per_week" value="<?php echo $row['chicken_per_week'];?>" > 
                    </div>
                ...
                <div class="form-lifestyle">                      
                    ...
                    <input type="number" step="1" name="litre"  value="<?php echo $row['litre'];?>">
                </div>
